...
# 점수판에 적용
scoreboard players display numberformat 05 serverboard fixed [{shadow_color:[0,0,0,1],color:"#99FFFF",bold:1b,text:""},{score:{name:"#h1",objective:serverboard}},":",{score:{name:"#m1",objective:serverboard}},":",{score:{name:"#s1",objective:serverboard}}]